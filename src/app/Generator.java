...
public class Generator {
	...
	/* I konstruktorn skapar vi ett färgintervall
	 *  som täcker antal iterationer och skapar färgobjekten(optimering) */
	public Generator() {
	...
	public void render(MandelbrotGUI gui) {
		...
		/* Hanterar kommandon angående
		 *  upplösning från användargränssnittet */
		...
		/* Förbereder rutans pixelplan för grafiken,
		 * vi delar med resDiff för att vi ej kommer att ha lika många
		 * färgobjekt för att beskriva vår yta. */
		Color[][] picture = new Color[gui.getHeight() / resDiff + 1]
				[gui.getWidth() / resDiff + 1];
		
		/* Här loopar vi igenom talplanet för att se
		 *  om det komplexa talet tillhör mängden eller ej
		 *  för att sedan färglägga enligt tidigare
